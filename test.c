...
//@TODO - 1 Set the clock, (//) �ּ� ǥ�ø� ���ְ� Ʋ�� ���� �ִٸ� ����� �� ������ �����Ͻÿ� 
        ...
        RCC->CFGR |= (uint32_t)(RCC_CFGR_PLLSRC_PREDIV1 | RCC_CFGR_PLLSCR_PREDIV1 | RCC_CFGR_PLLMULL4);
...
//@TODO - 3 RCC Setting
    ...
    /* USART RCC Enable */
    RCC->APB2ENR |= (uint32_t)RCC_APB2ENR_USUART1EN;
...
//@TODO - 4 GPIO Configuration
    ...
    */
    ...
    GPIOA->CRH |= (uint32_t)(GPIO_CRH_CNF8_1 | GPIO_CRH_MODE8_1 | GPIO_CRH_MODE8_0);
    /* USART Pin Configuration */
    GPIOA->CRH |= (uint32_t)(GPIO_CRH_CNF9_1 | GPIO_CRH_MODE9_1 | GPIO_CRH_MODE9_0 | GPIO_CRH_CNF10_1);
...
//@TODO - 9: Stop bit : 1bit
    USART1->CR2 |= (uint32_t)(USART_CR2_STOP_1);
